...
public final class PathManager {
    ...
    private PathManager() {
        ...
        try {
            ...
            if (Files.isRegularFile(codeLocation)) {
                ...
                if (installPath == null) {
                    logger.error("Failed to find the natives dir - unable to launch!");
            ...
            logger.error("Failed to convert code location to uri");
        }
    ...
    private Path findNativesHome(Path startPath, int maxDepth) {
        ...
        logger.error("Failed to find the natives dir within " + maxDepth + " levels of " + startPath);
        return null;
    }
